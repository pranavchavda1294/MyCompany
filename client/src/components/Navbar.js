    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">MyCompany</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/admins">
            <ListItem button key="Admin">
              ...
              <ListItemText className="menu-text" primary="Admin" />
            </ListItem>
          </Link>{" "}            
           <Link to="/clients">
            <ListItem button key="Client">
              ...
              <ListItemText className="menu-text" primary="Client" />
            </ListItem>
          </Link>{" "}            
           <Link to="/employes">
            <ListItem button key="Employe">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Employe" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
